...
export const SyncDrawer = ({ isOpen, onClose, syncStatus, onTriggerSync, }) => {
    ...
    return (_jsx("div", { className: "pos-panel-overlay", onClick: onClose, children: _jsxs("div", { className: "pos-panel", onClick: (e) => e.stopPropagation(), role: "dialog", "aria-label": "Sync diagnostics", children: [_jsxs("div", { style: { display: "flex", alignItems: "center", justifyContent: "space-between" }, children: [_jsxs("div", { children: [_jsx("h3", { style: { fontSize: 15, fontWeight: 700 }, children: "Diagnostics" }), _jsx("p", { style: { fontSize: 11, color: "var(--text-muted)", marginTop: 2 }, children: "SQLite cache & sync telemetry \u2014 for troubleshooting" })] }), _jsx("button", { onClick: onClose, className: "pos-icon-btn", title: "Close", "aria-label": "Close diagnostics", children: _jsx(IconClose, { size: 18 }) })] }), _jsxs("div", { style: {
                        ...
                        gap: 10,
                                ...
                                lineHeight: 1.3,
                            }, children: syncStatus.errorMessage }))] }), _jsxs("div", { style: { display: "flex", flexDirection: "column", gap: 6 }, children: [_jsx("span", { style: { fontSize: 11, fontWeight: 700, letterSpacing: "0.06em", color: "var(--text-muted)", textTransform: "uppercase" }, children: "Local Storage Telemetry" }), _jsxs("div", { style: {
                                padding: 12,
                                borderRadius: "var(--radius-md)",
                                backgroundColor: "var(--bg-surface-elevated)",
                                border: "1px solid var(--border-subtle)",
                                ...
                                gap: 8,
                                fontSize: 12,
                            }, children: [_jsxs("div", { style: { display: "flex", justifyContent: "space-between" }, children: [_jsx("span", { style: { color: "var(--text-muted)" }, children: "Storage Engine" }), _jsx("span", { style: { fontFamily: "var(--font-mono)" }, children: "SQLite 3 (WAL)" })] }), _jsxs("div", { style: { display: "flex", justifyContent: "space-between" }, children: [_jsx("span", { style: { color: "var(--text-muted)" }, children: "Active Products Cached" }), _jsx("span", { style: { fontFamily: "var(--font-mono)", fontWeight: 700 }, children: syncStatus?.productsCount ?? 0 })] }), _jsxs("div", { style: { display: "flex", justifyContent: "space-between" }, children: [_jsx("span", { style: { color: "var(--text-muted)" }, children: "Tax Categories Cached" }), _jsx("span", { style: { fontFamily: "var(--font-mono)", fontWeight: 700 }, children: syncStatus?.taxCategoriesCount ?? 0 })] }), _jsxs("div", { style: { display: "flex", justifyContent: "space-between" }, children: [_jsx("span", { style: { color: "var(--text-muted)" }, children: "Source API Target" }), _jsx("span", { style: { fontFamily: "var(--font-mono)", color: "var(--accent-blue)" }, children: "/api/products" })] })] })] }), _jsxs("div", { style: { display: "flex", flexDirection: "column", gap: 6 }, children: [_jsx("span", { style: { fontSize: 11, fontWeight: 700, letterSpacing: "0.06em", color: "var(--text-muted)", textTransform: "uppercase" }, children: "Backend Server" }), _jsxs("div", { style: {
                                padding: 12,
                                borderRadius: "var(--radius-md)",
                                backgroundColor: "var(--bg-surface-elevated)",
                                border: "1px solid var(--border-subtle)",

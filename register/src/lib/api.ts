...
function mapBackendProductToCached(p: any): CachedProduct {
  return {
    id: p.id,
    sku: p.sku,
...
function mapBackendCategoryToCached(c: any): CachedCategory {
  return {
    id: c.id,
    name: c.name,
...
function mapBackendTaxCategoryToCached(tc: any): CachedTaxCategory {
  return {
    id: tc.id,
    name: tc.name,

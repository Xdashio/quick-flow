...
async function jwtVerify(jwt, key, options) {
    ...
    if (!verified[2]) throw new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$jose$2f$dist$2f$webapi$2f$util$2f$errors$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["JWTInvalid"]("JWTs MUST NOT use unencoded payload");
    const result = {
        payload: (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$jose$2f$dist$2f$webapi$2f$lib$2f$jwt_claims_set$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["validateClaimsSet"])(verified[1], verified[0], options),
...
function parseJoseHeader(b64, ErrorClass, message) {
    ...
    if (!(0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$jose$2f$dist$2f$webapi$2f$lib$2f$type_checks$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["isObject"])(parsed)) throw new ErrorClass(message);
    return parsed;
}
;
}),
...
function snapshotJws(jws, sharedPayload) {
    const encodedProtected = jws.protected, inputHeader = jws.header, header = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$jose$2f$dist$2f$webapi$2f$lib$2f$type_checks$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["isObject"])(inputHeader) ? {
        ...inputHeader
    } : inputHeader;
...
function verifyResult(jws, verified) {
    const [payload, parsedProt, , key, resolvedKey] = verified, result = {
        payload
    };
    return jws.protected !== void 0 && (result.protectedHeader = parsedProt), jws.header !== void 0 && (result.unprotectedHeader = jws.header), resolvedKey ? {
        ...result,
        key
    } : result;
}
...
async function verifyCompact(jws, shared, key) {
    ...
    const compactJws = {
        ...
        signature
    }, parsedProt = parseProtectedHeader(protectedHeader), [b64, alg] = validateJwsHeaders(parsedProt, parsedProt, shared), signingPayload = b64 ? payload : encodeCompactUnencodedPayload(payload);
...
function validateClaimsSet(protectedHeader, encodedPayload, options = {}) {
    ...
    if (!(0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$jose$2f$dist$2f$webapi$2f$lib$2f$type_checks$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["isObject"])(payload)) throw new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$jose$2f$dist$2f$webapi$2f$util$2f$errors$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["JWTInvalid"]("JWT Claims Set must be a top-level JSON object");
    const { typ } = options;
...
class JWTClaimsBuilder {
    constructor(payload = {}){
        if (!(0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$jose$2f$dist$2f$webapi$2f$lib$2f$type_checks$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["isObject"])(payload)) throw new TypeError("JWT Claims Set MUST be an object");
...
function checkKeyType(entry, key, usage) {
    ...
    if ((0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$jose$2f$dist$2f$webapi$2f$lib$2f$type_checks$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["isObject"])(key)) {
        ...
        return jwkMatchesOp(entry, normalized, usage), [
            JWK,
            key,
            normalized
        ];
    }
    if (!(0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$jose$2f$dist$2f$webapi$2f$lib$2f$is_key_like$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["isKeyLike"])(key)) throw new TypeError(secret ? (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$jose$2f$dist$2f$webapi$2f$lib$2f$invalid_key_input$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["withAlg"])(alg, key, "CryptoKey", "KeyObject", "JSON Web Key", "Uint8Array") : (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$jose$2f$dist$2f$webapi$2f$lib$2f$invalid_key_input$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["withAlg"])(alg, key, "CryptoKey", "KeyObject", "JSON Web Key"));
    if (secret) {
...
function cached(key, alg, value) {
    ...
    return value && (entry ? entry[alg] = value : cache.set(key, {
        [alg]: value
    })), value ?? entry?.[alg];
}
const handleJWK = async (key, jwk, entry)=>cached(key, entry.alg) ?? cached(key, entry.alg, await (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$jose$2f$dist$2f$webapi$2f$lib$2f$jwk_to_key$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["jwkToKey"])(entry, {
    ...
    if (hit) return hit;
    const isPublic = keyObject.type === "public", usages = entry.usages[isPublic ? 0 : 1], { asymmetricKeyType } = keyObject, crv = nist[keyObject.asymmetricKeyDetails?.namedCurve], params = entry.resolve?.({
        crv,
        asymmetricKeyType
    }) ?? entry.subtle;
        ...
        case JWK:
            {
                ...
                if (normalized.kty === "oct") return (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$jose$2f$dist$2f$webapi$2f$util$2f$base64url$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["decode"])(normalized.k);
        ...
        case KEYOBJECT:
            {
                ...
                return keyObject.type === "secret" ? keyObject.export() : "toCryptoKey" in keyObject && typeof keyObject.toCryptoKey == "function" ? handleKeyObject(keyObject, entry) : handleJWK(keyObject, keyObject.export({
                    format: "jwk"
                }), entry);
            }
    }
...
function validateAlgorithms(option, algorithms) {
    ...
    if (algorithms) return new Set(algorithms);
}
...
function serializeJoseHeader(Err, header) {
    ...
    if (!(0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$jose$2f$dist$2f$webapi$2f$lib$2f$type_checks$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["isObject"])(parsed)) throw new Err("JOSE Header is not a JSON object");
    return [
        parsed,
        serialized
    ];
...
async function getSigKey(entry, key, usage) {
    return key instanceof Uint8Array ? crypto.subtle.importKey("raw", key, entry.subtle, !1, [
        usage
    ]) : ((0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$jose$2f$dist$2f$webapi$2f$lib$2f$crypto_key$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["checkCryptoKey"])(key, entry.subtle, usage), entry.minRsaBits && (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$jose$2f$dist$2f$webapi$2f$lib$2f$crypto_key$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["checkModulusLength"])(entry.alg, key), key);
}
...
function decode(input) {
    ...
    let encoded = input;
    if (encoded instanceof Uint8Array && (encoded = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$jose$2f$dist$2f$webapi$2f$lib$2f$buffer_utils$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["decoder"].decode(encoded)), encoded.includes("+") || encoded.includes("/")) throw new TypeError(invalid);
...
function encode(input) {
    let unencoded = input;
    return typeof unencoded == "string" && (unencoded = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$jose$2f$dist$2f$webapi$2f$lib$2f$buffer_utils$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["encoder"].encode(unencoded)), Uint8Array.prototype.toBase64 ? unencoded.toBase64({
        alphabet: "base64url",
        omitPadding: !0
    }) : (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$jose$2f$dist$2f$webapi$2f$lib$2f$base64$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["encodeBase64"])(unencoded).replace(/=/g, "").replace(/\+/g, "-").replace(/\//g, "_");
}
;
}),
...
//# sourceMappingURL=node_modules_0dikja-._.js.map